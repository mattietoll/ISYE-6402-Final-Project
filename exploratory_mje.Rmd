...
```{r}
vehicles <- read.csv("C:\\Users\\ernst\\OneDrive\\Regression Analysis\\VehicleData-1.csv")
...
-   sales appears to be more constant than new orders

Sales data ACF/PACF:

```{r}
acf(sales, lag.max = 60, main = "ACF Sales")
pacf(sales, lag.max = 60, main = "PACF Sales")
acf(orders, lag.max = 60, main = "ACF Orders")
pacf(orders, lag.max = 60, main = "PACF Orders")
```
